...
export default function InfluencerLayout() {
  ...
  { to: "/influencer/vertical-connections/home", label: "首页", menuHint: "หน้าแรก", icon: "🏠", group: "vertical" },
  { to: "/influencer/vertical-connections/invitations", label: "建联邀请", menuHint: "ดูคำเชิญเชื่อมต่อ", icon: "📨", group: "vertical" },
  { to: "/influencer/vertical-connections/orders", label: "我的派单", menuHint: "รายการคำสั่งงาน", icon: "📋", group: "vertical" },
