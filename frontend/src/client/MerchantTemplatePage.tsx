...
const MerchantTemplatePage: React.FC = () => {
  return (
    <div style={{ padding: compactPx(20) }}>
      ...
      <div style={{ maxWidth: compactPx(800), background: "#fff", borderRadius: compactPx(16), padding: compactPx(24), boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.1)" }}>
        <MerchantInfoForm />
        <div style={{ marginTop: compactPx(20), textAlign: "right" }}>
          <p style={{ fontSize: compactPx(13), color: "#94a3b8" }}>
