  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 0, marginBottom: 20, borderBottom: "2px solid #e2e8f0" }}>
        {[
          { label: "📊 数据看板", path: "/admin/vertical-connections/purchase" },
          { label: "进货需求", path: "/admin/vertical-connections/purchase/demands" },
          ...
          { label: "供应商管理", path: "/admin/vertical-connections/purchase/suppliers" },
          { label: "财务管理", path: "/admin/vertical-connections/purchase/finance" },
        ].map((tab) => {
