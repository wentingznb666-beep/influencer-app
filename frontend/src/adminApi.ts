...
export async function createMaterial(body: { title: string; type: string; cloud_link: string; platforms?: string; remark?: string }) {
  ...
  const res = await fetchWithAuth("/api/admin/materials", { method: "POST", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function updateMaterial(id: number, body: Record<string, unknown>) {
  ...
  const res = await fetchWithAuth(`/api/admin/materials/${id}`, { method: "PATCH", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function createTask(body: {
  ...
  const res = await fetchWithAuth("/api/admin/tasks", { method: "POST", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function updateTask(
  ...
  const res = await fetchWithAuth(`/api/admin/tasks/${id}`, { method: "PATCH", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function updateInfluencerProfile(userId: number, body: { show_face?: number; tags?: string; platforms?: string; blacklisted?: number; level?: number }) {
  ...
  const res = await fetchWithAuth(`/api/admin/influencers/${userId}/profile`, { method: "PUT", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function rejectSubmission(id: number, reason?: string) {
  ...
  const res = await fetchWithAuth(`/api/admin/submissions/${id}/reject`, { method: "POST", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify({ reason }) });
...
export async function updateRechargeOrder(id: number, body: { status: "approved" | "rejected"; note?: string }) {
  ...
  const res = await fetchWithAuth(`/api/admin/points/recharge-orders/${id}`, { method: "PATCH", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function generateSettlement(week: string) {
  ...
  const res = await fetchWithAuth("/api/admin/settlement/generate", { method: "POST", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify({ week }) });
...
export async function updateSettlementStatus(id: number, body: { status: string; note?: string }) {
  ...
  const res = await fetchWithAuth(`/api/admin/settlement/${id}`, { method: "PATCH", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function triggerRiskCheck(submissionId: number) {
  ...
  const res = await fetchWithAuth("/api/admin/risk/check", { method: "POST", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify({ submission_id: submissionId }) });
...
export async function updateWithdrawal(id: number, body: { status: "paid" | "rejected"; note?: string }) {
  ...
  const res = await fetchWithAuth(`/api/admin/withdrawals/${id}`, { method: "PATCH", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function createUserByAdmin(body: { username: string; password: string; role: AdminCreatableRole; display_name?: string }) {
  ...
  const res = await fetchWithAuth("/api/admin/users", { method: "POST", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function createAdminModel(body: { name: string; photos: string[]; intro?: string; cloud_link: string; status?: "enabled" | "disabled"; tiktok_followers_text?: string; tiktok_sales_text?: string; sellable_product_types?: string; skills_text?: string }) {
  ...
  const res = await fetchWithAuth("/api/admin/models", { method: "POST", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function updateAdminModel(id: number, body: { name?: string; photos?: string[]; intro?: string; cloud_link?: string; status?: "enabled" | "disabled"; tiktok_followers_text?: string; tiktok_sales_text?: string; sellable_product_types?: string; skills_text?: string }) {
  ...
  const res = await fetchWithAuth(`/api/admin/models/${id}`, { method: "PATCH", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function requestAdminModelStatus(id: number, status: "enabled" | "disabled") {
  ...
  const res = await fetchWithAuth(`/api/admin/models/${id}/status-request`, { method: "POST", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify({ status }) });
...
export async function createAdminShowcaseInfluencer(body: {
  ...
  const res = await fetchWithAuth("/api/admin/showcase-influencers", { method: "POST", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function updateAdminShowcaseInfluencer(
  ...
  const res = await fetchWithAuth(`/api/admin/showcase-influencers/${id}`, { method: "PATCH", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function createAdminShowcaseContentCreator(body: {
  ...
  const res = await fetchWithAuth("/api/admin/showcase-content-creators", { method: "POST", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
...
export async function updateAdminShowcaseContentCreator(
  ...
  const res = await fetchWithAuth(`/api/admin/showcase-content-creators/${id}`, { method: "PATCH", headers: { "Content-Type": "application/json; charset=utf-8" }, body: JSON.stringify(body) });
