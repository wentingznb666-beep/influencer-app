...
- [x] 设计并实现客户任务/需求表（产品信息、目标平台、预算、是否露脸）（优先级：高）（模块：商家端）
- [x] 实现客户合作信息与样品寄送记录表及 API（优先级：高）（模块：商家端）
- [x] 实现订单跟踪系统 API（状态、时间节点、关联达人/任务）（优先级：高）（模块：商家端）
- [x] 实现客户查看达人发布作品列表 API（优先级：高）（模块：商家端）
...
|----------------|------|----------|------------------------|
| 商家端 | 待开发 | 阶段 3 | 客户任务/样品/订单跟踪、作品列表、积分充值；前端合作意向、订单跟踪、作品展示 |
